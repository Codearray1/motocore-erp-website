          ...
          >
            ...
            {!submitted ? (
              ...
              <div className="text-center py-6 space-y-5">
                <div className="inline-flex p-3 rounded-full bg-[#E30613] text-white shadow-lg">
                  <CheckCircle className="h-8 w-8 stroke-[2.5]" />
                </div>
                <div className="space-y-2">
                 <h4 className="text-xl font-bold font-display text-gray-900 dark:text-white">Thank You! </h4>
                <p className="text-sm text-gray-600 dark:text-gray-300 max-w-sm mx-auto leading-relaxed"> Your request has been submitted successfully.
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto leading-relaxed mt-2"> Our MotoCore team will review your details and contact you shortly with beta access information.
                </p>
                </div>
                <button
                  onClick={onClose}
  ...
  try {
    const response = await fetch("/api/contact", {
      ...
      body: JSON.stringify({
        ...
        businessName: "Not provided",
        businessType: fields.branchCount,
